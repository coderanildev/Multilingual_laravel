...
@section('content')
<title>Dashboard - Edit Announcement</title>
...
<div class="col-12 col-xl-12">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            ...
            <h2 class="h5 mb-4">Edit Announcement</h2>
            @if(session('success'))
            ...
            <form method="POST" action="{{ route('dashboard.newannouncement.update', $item->id) }}" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        @if($item->document)
                            <small class="text-muted d-block mt-2">
                                Current:
                                <a href="{{ asset('includes/images/announcementsnew/'.$item->document) }}"  target="_blank">
                                    {{ $item->document }}
                                </a>
                            </small>
                        @endif
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ route('dashboard.newannouncement.index') }}" class="btn btn-secondary"> Cancel </a>
                </div>
            </form>
        </div>
    </div>
