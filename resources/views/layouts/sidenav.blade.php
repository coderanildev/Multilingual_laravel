<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
  <div class="sidebar-inner px-2 pt-3">
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        <div class="avatar-lg me-4">
          <img src="{{ asset('assets/img/profile.png') }}" class="card-img-top rounded-circle border-white"
            alt="Profile Picture">
        </div>
        <div class="d-block">
          <h2 class="h5 mb-3">Hi, Niscpr</h2>
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item">
          <a href="{{ route('dashboard.tender') }}" class="nav-link">
              <span class="sidebar-icon"><i class="fas fa-file-contract me-2"></i></span>
              <span class="sidebar-text">Tender</span>
          </a>
      </li>

      <li class="nav-item">
          <a href="{{ route('dashboard.jobs') }}" class="nav-link">
      ...
      <li class="nav-item">
          <a href="{{ route('dashboard.notifications') }}" class="nav-link">
